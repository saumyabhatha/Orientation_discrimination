...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='D:\\AU\\PSY310\\Orientation Discrimination\\Orientation_discrimination_lastrun.py',
...
text = visual.TextStim(win=win, name='text',
    text='A gradient will appear on the screen, you have to judge the orientation of the tilt. If there is no tilt press the up arrow key. If there is tilt press the down arrow key. \n\nIf you have understood the instructions continue to the experiment by pressing space.',
    font='Open Sans',
    ...
    while continueRoutine:
        ...
        if key_resp.status == STARTED and not waitOnFlip:
            ...
            if len(_key_resp_allKeys):
                ...
                # was this correct?
                if (key_resp.keys == str(cor_Ans)) or (key_resp.keys == cor_Ans):
                    key_resp.corr = 1
                else:
                    key_resp.corr = 0
                # a response ends the routine
